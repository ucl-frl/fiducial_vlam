# for real drone operation (joystick and keyboard control enabled)
# using vloc and vmap node from fiducial_vlam to detect AruCo markers and perform localization and mapping
...
vloc_args = [{
    ...
    'map_init_pose_z': -1, # changes here do not apply to the origin of map, need to further review
